...
# -------- CONFIG --------
BOT_TOKEN = "8148294292:AAFjdLY7yPxX-mOUZfUxfkSkG-uYiv5t5R4"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if not is_owner(update.effective_user.id):
        return
    await update.message.reply_text("🤖 Fourth Bot Online\nUse /help")
...
async def gcnc(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("✅ GCNC started (FOURTH BOT – FOLLOWER-3 MODE)")
